...
const AddCafeteriaScreen: React.FC = () => {
  ...
  const handleSubmit = async () => {
    ...
    try {
      const response = await fetch('http://127.0.0.1:3000/Cafeteria/add', {
        method: 'POST',
        headers: {
      ...
      console.log('Error adding cafeteria:', error);
    }
  };
...
export default AddCafeteriaScreen;
